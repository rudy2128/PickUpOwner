...
import com.anthony.myapplication.ui.trx.TrxAdapter
...
class HistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        trxViewModel = ViewModelProvider(this@HistoryActivity)[TrxViewModel::class.java]
        ...
        trxViewModel.getAllTrxHis().observe(this){
            trxList.clear()
            trxList.addAll(it)
    ...
    private fun searchList(text: String?) {
        ...
        for (dataPro in trxList){
            if (dataPro.customers!!.name?.lowercase()?.contains(text!!.lowercase()) == true ||
                dataPro.customers!!.address?.lowercase()?.contains(text!!.lowercase()) == true || dataPro.startDate!!.lowercase().contains(text!!.lowercase())){
