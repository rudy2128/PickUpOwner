...
class DetailTrxActivity : AppCompatActivity() {
    ...
    private lateinit var btnCost: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCost = findViewById(R.id.btn_cost)
        ...
        trxViewModel = ViewModelProvider(this@DetailTrxActivity)[TrxViewModel::class.java]
        empViewModel = ViewModelProvider(this@DetailTrxActivity)[EmpViewModel::class.java]
        ...
        trxViewModel.getTrxById(trxId).observe(this@DetailTrxActivity){
            orders.clear()
        ...
        btnFinish.setOnClickListener {
            if (status == "Dikirim"){
                val i = Intent(applicationContext,FinishActivity::class.java)
                i.putExtra("TRX_ID",trxId)
                startActivity(i)

            }else{
                Toast.makeText(applicationContext,"Masukan data pengirim dahulu!!", Toast.LENGTH_SHORT).show()
            }
        ...
        btnCost.setOnClickListener {
            if (cost == 0){
                ...
                Toast.makeText(applicationContext,"Biaya sudah diinput!!", Toast.LENGTH_SHORT).show()
            }
        }
        btnSendOrder.setOnClickListener {
            if (status == "Diambil"){
                ...
                Toast.makeText(applicationContext,"Order sudah dikirim/belum diambil!!", Toast.LENGTH_SHORT).show()
    ...
    private fun showCostDialog() {
        val builder = AlertDialog.Builder(this@DetailTrxActivity)
        builder.setTitle("Total biaya")
        val edtCost = EditText(this@DetailTrxActivity)
    ...
    private fun shoDialog() {
        ...
        builder.setPositiveButton(getString(R.string.yes)) { _, _ ->
            ...
            empViewModel.getEmpById().observe(this@DetailTrxActivity){
                val name = it.name
